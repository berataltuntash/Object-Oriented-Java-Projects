...
public class Product {
	...
	public String toString(){
		return "Id: "+this.getProductId()+" Title: "+this.getProductTitle()+" Rate: "+this.getProductRate()+ " Number of reviews: "+this.getProductNumberOfReviews()+" Price: "+this.getProductPrice();
	}
